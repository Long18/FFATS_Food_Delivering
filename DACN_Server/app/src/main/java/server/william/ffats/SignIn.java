        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(@NonNull LocationResult locationResult) {
                ...
                if (LastLocation != null) {
                    ...
                    try {
                        geocoder = new Geocoder(SignIn.this, Locale.getDefault());
                ...
                .addConnectionCallbacks(new GoogleApiClient.ConnectionCallbacks() {
                    ...
                    public void onConnected(Bundle bundle) {
                        if (ActivityCompat.checkSelfPermission(SignIn.this, Manifest.permission.ACCESS_FINE_LOCATION)
                                != PackageManager.PERMISSION_GRANTED
                                && ActivityCompat.checkSelfPermission(SignIn.this, Manifest.permission.ACCESS_COARSE_LOCATION)
                                != PackageManager.PERMISSION_GRANTED) {
                    ...
                    public void onConnectionFailed(ConnectionResult connectionResult) {
                        if (connectionResult.hasResolution()) {
                            try {
                                ...
                                connectionResult.startResolutionForResult(SignIn.this, PLAY_SERVICES_RESOLUTION_REQUEST);
                            } catch (IntentSender.SendIntentException e) {
                                e.printStackTrace();
                            }
                        } else {
                            Toast.makeText(SignIn.this, "bug", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                .addApi(API)
